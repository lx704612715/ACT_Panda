...
logger.info(f"Mean episode length: {mean_episode_len}")

for name in aligned_data.keys():
    episode_len = aligned_data[name]['qpos'].shape[0]
    if episode_len > mean_episode_len:
        aligned_data[name]['qpos'] = aligned_data[name]['qpos'][:mean_episode_len]
        aligned_data[name]['qvel'] = aligned_data[name]['qvel'][:mean_episode_len]
        aligned_data[name]['action'] = aligned_data[name]['action'][:mean_episode_len]
        ...
        diff_episode_len = mean_episode_len - episode_len
